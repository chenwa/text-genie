...
const translations: Record<SupportedLang, {
  ...
  es: {
    ...
    askGenie: 'Entrenador de Escritura',
  ...
  it: {
    ...
    askGenie: 'Allenatore di Scrittura',
    login: 'Accedi',
    signUp: 'Registrati',
    signOut: 'Esci',
