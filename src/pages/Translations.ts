...
const translations: Record<SupportedLang, {
  ...
  id: {
    ...
    heroSubtitle: 'Tulis email, laporan, dan dokumen dengan jelas dan percaya diri. Typing Genie membantu Anda dari ide ke teks yang sempurna dalam hitungan detik.',
    heroCta: 'Daftar Gratis',
    heroTagline: 'Cukup ketik ide Anda. Kami yang merangkai kata-katarnya.',
    demoTitle: '✨ Coba Demo Typing Genie',
  ...
  ko: {
    ...
    heroSubtitle: '명확하고 자신감 있게 이메일, 보고서, 문서를 작성하세요. Typing Genie가 몇 초 안에 아이디어를 세련된 텍스트로 바꿔드립니다.',
    heroCta: '무료 가입',
    heroTagline: '아이디어만 입력하세요. 나머지는 저희가 처리합니다.',
    demoTitle: '✨ Typing Genie 데모 체험',
    ...
    demoGenerateTooltip: 'TypingGenie가 완벽한 텍스트를 만들어드릴게요!',
